...
;; 开/关中文：Ctrl+Space / F12
(define generic-on-key '("<Control> " "F12"))
(define generic-on-key? (make-key-predicate '("<Control> " "F12")))
(define generic-off-key '("<Control> " "F12"))
(define generic-off-key? (make-key-predicate '("<Control> " "F12")))
