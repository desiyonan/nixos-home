...
let
  ...
  users = lib.attrsets.mapAttrsToList (n: u: u) (
    lib.attrsets.filterAttrs (n: u: builtins.elem n ug.members) all_users
  );
...
in
{
  options.modules.secrets = {
    enable = lib.mkEnableOption "SOPS secrets tmpfiles mounts (requires secret-hub)";
  };
